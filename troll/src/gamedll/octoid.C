...
TrollThing *TrollOctoid::createBlueOctoid(TrollScreen *scr,
  IUShort secrt = 0)
{
 return new TrollOctoid(scr, secrt, 0, 3);
}
...
TrollOctoid::TrollOctoid(TrollScreen *scr, IUShort secrt, IUShort shft,
  IUShort spd)
